...
import com.wyh.iquestion.util.FileUtil;
import com.wyh.iquestion.util.UiUtil;
import com.wyh.iquestion.util.WindowUtil;
...
public class TopicActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 设置背景
		getWindow().setBackgroundDrawableResource(R.mipmap.bg_base);
